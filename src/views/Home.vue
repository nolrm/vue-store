<template>
  <MainLayout>
    <div class="page-home text-center">
      <div class="w-4/5 md:w-1/2 m-auto">
        ...
        <div class="flex space-x-3 place-content-center items-center mt-10">
          <div>
            <img src="/vite.svg" alt="Vite" class="w-auto h-18" />
          </div>
          ...
          <div>
            <svg class="h-8" viewBox="0 0 128 128" data-v-28205da4="">
              <path
                fill="#42b883"
